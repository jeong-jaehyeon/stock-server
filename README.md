...
✅ 포트폴리오 추가 (`POST /api/portfolio`) 기능 구현 중  
✅ 포트폴리오 삭제 (`DELETE /api/portfolio/:symbol`) API 구현 예정  
✅ 포트폴리오 조회 (`GET /api/portfolio`) API 구현 예정
...
🔜 포트폴리오 삭제 API (`DELETE /api/portfolio/:symbol`) 구현  
🔜 프론트엔드 개발 시작 (추후 진행)
